...
**Сканирование с NULL-обработкой:**
- Для pointer-полей (`*Order`) SQL-значения сканируются во временный срез `[]any`
...
7. **Multi-table запросы (Query[QROW])** — SELECT с JOIN, авто-вывод ON из ref=,
