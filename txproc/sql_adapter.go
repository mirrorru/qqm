...
func (a DBAdapter) ExecContext(ctx context.Context, query string, args ...any) (qqm.Result, error) {
	return a.db.ExecContext(ctx, query, args...)
}

// QueryContext выполняет запрос, возвращающий строки.
// EN: QueryContext executes a query that returns rows.
func (a DBAdapter) QueryContext(ctx context.Context, query string, args ...any) (qqm.Rows, error) {
...
func (a DBAdapter) QueryRowContext(ctx context.Context, query string, args ...any) qqm.Row {
...
// ExecContext выполняет запрос, не возвращающий строк.
// EN: ExecContext executes a query that does not return rows.
func (a TxAdapter) ExecContext(ctx context.Context, query string, args ...any) (qqm.Result, error) {
	return a.tx.ExecContext(ctx, query, args...)
}

// QueryContext выполняет запрос, возвращающий строки.
// EN: QueryContext executes a query that returns rows.
func (a TxAdapter) QueryContext(ctx context.Context, query string, args ...any) (qqm.Rows, error) {
	return a.tx.QueryContext(ctx, query, args...)
}

// QueryRowContext выполняет запрос, возвращающий одну строку.
// EN: QueryRowContext executes a query that returns a single row.
func (a TxAdapter) QueryRowContext(ctx context.Context, query string, args ...any) qqm.Row {
